...
const NewPKPage: React.FC<BurnerContext & RouteComponentProps> = ({ history, assets, actions, defaultAccount }) => {
  const getPK = () => {
  ...
  return (
    <Page title="New Private Key">{content}</Page>
  );
}

export default withBurner(NewPKPage);
