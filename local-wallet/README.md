This sample relies on packages in the root Burner-wallet-2 folder. Before using this make sure you build the dependcies, by running `yarn run build` in the root Burner-wallet-2 folder.
